...
export function PublicFooter() {
  ...
  const openLegalModal = (e: React.MouseEvent<HTMLAnchorElement>, docType: LegalDocType) => {
    e.preventDefault();
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10 md:gap-12">
            ...
            <nav aria-label="Credit card resources">
              ...
              <ul className="space-y-4">
                ...
                <li><Link to="/cards?category=travel" className="text-sm text-gray-400 hover:text-white transition-colors">Best Travel Cards</Link></li>
                <li><Link to="/cards?category=shopping" className="text-sm text-gray-400 hover:text-white transition-colors">Best Cashback Cards</Link></li>
                <li><Link to="/cards?category=fuel" className="text-sm text-gray-400 hover:text-white transition-colors">Best Fuel Cards</Link></li>
                <li><Link to="/cards" className="text-sm text-gray-400 hover:text-white transition-colors">Best Student Cards</Link></li>
                <li><Link to="/cards" className="text-sm text-gray-400 hover:text-white transition-colors">Lifetime Free Cards</Link></li>
              </ul>
            </nav>
            ...
            <nav aria-label="Legal and trust pages">
              ...
              <ul className="space-y-4">
                <li><a href="#" onClick={(e) => openLegalModal(e, 'editorial')} className="text-sm text-gray-400 hover:text-white transition-colors">Editorial Policy</a></li>
                <li><a href="#" onClick={(e) => openLegalModal(e, 'affiliate')} className="text-sm text-gray-400 hover:text-white transition-colors">Affiliate Disclosure</a></li>
                <li><a href="#" onClick={(e) => openLegalModal(e, 'privacy')} className="text-sm text-gray-400 hover:text-white transition-colors">Privacy Policy</a></li>
                <li><a href="#" onClick={(e) => openLegalModal(e, 'terms')} className="text-sm text-gray-400 hover:text-white transition-colors">Terms of Service</a></li>
                <li><a href="#" onClick={(e) => openLegalModal(e, 'disclaimer')} className="text-sm text-gray-400 hover:text-white transition-colors">Financial Disclaimer</a></li>
              </ul>
            </nav>
      ...
      <LegalModal doc={activeLegalDoc} onClose={() => setActiveLegalDoc(null)} />
    </>
  );
}
