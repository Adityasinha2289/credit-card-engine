    ...
    <section className="w-full py-40 bg-[#0A0A0A] text-white relative overflow-hidden flex flex-col items-center justify-center border-t border-white/[0.04]">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center flex flex-col items-center">
        ...
        <FadeInView delay={0.2}>
          <MotionButton className="group bg-[#00E599] text-[#0A0A0A] font-bold text-lg md:text-xl px-10 py-5 rounded-xl flex items-center justify-center gap-4 hover:bg-[#00c985] transition-colors">
            Find My Best Card
